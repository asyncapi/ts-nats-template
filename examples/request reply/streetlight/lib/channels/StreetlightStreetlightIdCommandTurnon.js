...
function reply(onRequest, onReplyError, client, streetlight_id, options) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let subscription = yield client.subscribe(`streetlight.${streetlight_id}.command.turnon`, (err, msg) => __awaiter(this, void 0, void 0, function* () {
                if (err) {
                    onRequest(err);
                }
                else {
                    ...
                    let message = yield onRequest(undefined, AnonymousSchema_1_1.AnonymousSchema_1.unmarshal(receivedData), streetlightIdParam);
                    if (msg.reply) {
