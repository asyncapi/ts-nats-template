...
exports.NatsAsyncApiTestClient = exports.AnonymousSchema_5 = exports.GeneralReply = exports.AnonymousSchema_1 = exports.streetlightStreetlightIdEventTurnonChannel = exports.streetlightStreetlightIdCommandTurnonChannel = void 0;
...
class NatsAsyncApiTestClient {
     ...
     */
    requestStreetlightStreetlightIdCommandTurnon(requestMessage, streetlight_id, options) {
        if (!this.isClosed() && this.nc !== undefined && this.codec !== undefined) {
            return streetlightStreetlightIdCommandTurnonChannel.request(requestMessage, this.nc, this.codec, streetlight_id, options);
        }
        else {
     ...
     */
    replyToStreetlightStreetlightIdEventTurnon(onRequest, onReplyError, streetlight_id, flush, options) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            if (!this.isClosed() && this.nc !== undefined && this.codec !== undefined) {
                try {
                    const sub = yield streetlightStreetlightIdEventTurnonChannel.reply(onRequest, onReplyError, this.nc, this.codec, streetlight_id, options);
                    if (flush) {
                        yield this.nc.flush();
                    }
                    resolve(sub);
