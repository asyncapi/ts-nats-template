...
exports.GeneralReply = GeneralReply_1.GeneralReply;
const AnonymousSchema_5_1 = require("..//models/AnonymousSchema_5");
exports.AnonymousSchema_5 = AnonymousSchema_5_1.AnonymousSchema_5;
...
class NatsAsyncApiTestClient extends events.EventEmitter {
     ...
     */
    requestStreetlightStreetlightIdCommandTurnon(requestMessage, streetlight_id) {
        const nc = this.jsonClient;
        if (nc) {
            return streetlightStreetlightIdCommandTurnonChannel.request(requestMessage, nc, streetlight_id);
        }
        else {
    ...
    replyToStreetlightStreetlightIdEventTurnon(onRequest, onReplyError, streetlight_id, flush, options) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (nc) {
                try {
                    const sub = yield streetlightStreetlightIdEventTurnonChannel.reply(onRequest, onReplyError, nc, streetlight_id, options);
                    if (flush) {
