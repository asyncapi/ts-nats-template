...
exports.NatsAsyncApiClient = exports.TestClient = exports.NatsTypescriptTemplateError = exports.ErrorCode = exports.AnonymousSchema_3 = exports.AnonymousSchema_1 = exports.streetlightStreetlightIdEventTurnonChannel = exports.streetlightStreetlightIdCommandTurnonChannel = void 0;
...
class NatsAsyncApiClient {
    ...
    subscribeToStreetlightStreetlightIdCommandTurnon(onDataCallback, streetlight_id, flush, options) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            if (!this.isClosed() && this.nc !== undefined && this.codec !== undefined) {
                try {
                    const sub = yield streetlightStreetlightIdCommandTurnonChannel.subscribe(onDataCallback, this.nc, this.codec, streetlight_id, options);
                    if (flush) {
                        yield this.nc.flush();
                    }
                    resolve(sub);
     ...
     * @param streetlight_id parameter to use in topic
     */
    publishToStreetlightStreetlightIdEventTurnon(message, streetlight_id, options) {
        if (!this.isClosed() && this.nc !== undefined && this.codec !== undefined) {
            return streetlightStreetlightIdEventTurnonChannel.publish(message, this.nc, this.codec, streetlight_id, options);
        }
        else {
