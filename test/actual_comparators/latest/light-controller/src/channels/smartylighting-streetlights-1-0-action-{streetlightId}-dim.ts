...
export function reply(
  onRequest: (err?: NatsError, msg?: DimLightMessage) => DimLightResponseMessage, 
  ...
  return new Promise(async (resolve, reject) => {
    if (nc) {
      try {
        ...
        let subscription = nc.subscribe(realizeChannelName('smartylighting/streetlights/1/0/action/{streetlightId}/dim', {
          ...
          if (err) {
            ...
            let requestData = new DimLightMessage();
